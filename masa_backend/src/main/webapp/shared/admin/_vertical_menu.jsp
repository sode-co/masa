...
<body>
<ul class="form">
    <li><a class="all" href="/masa/admin/request-management/index.jsp"><i class="icon-user"></i>MANAGE REQUEST</a></li>
    <li><a class="all" href="/masa/admin/user-management/index.jsp"><i class="icon-user"></i>MANAGE ALL USERS</a></li>
    <li><a class="profile" href="/masa/admin/user-management/manage_mentor.jsp"><i class="icon-user"></i>MANAGE MENTORS</a></li>
<%--    <li class="selected"><a class="messages" href="/masa/admin/user-management/manage_guest.jsp"><i class="icon-bell"></i>MANAGE LECTURE<em>new</em></a></li>--%>
    <li><a class="settings" href="/masa/admin/user-management/manage_student.jsp"><i class="icon-cog"></i>MANAGE MEMBERS</a></li>
    <li><a class="calendar" href="/masa/admin/meeting/view_all.jsp"><i class="icon-calendar"></i>MANAGE MEETINGS</a></li>
