            ...
            <div class="container px-5 py-5 mx-auto">
                <div class="flex flex-wrap w-full mb-8">
                    <div class="w-full mb-6 lg:mb-0 sm:ml-20">
                        <h1 class="mb-2 text-5xl font-medium text-gray-900 sm:text-4xl title-font" id="notiTopicMeetings">
                ...
                <div id="carousel_wrapper1" class="max-w-full overflow-auto md:flex md:justify-center md:space-x-8 md:px-14"></div>
            </div>
            <script>
                ...
                fetch("http://localhost:8080/masa/api/meeting-management/topic-name/meetings", options)
                    ...
                    .then((res) => {
                        ...
                        if (width === 0) {
                            document.getElementById("notiTopicMeetings").innerHTML =
                                "There is no topic about " + keySearch + ". Sorry, you can search another topic.";
                        }
                        arr.forEach((element) => {
