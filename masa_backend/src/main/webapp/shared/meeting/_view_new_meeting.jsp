                ...
                $.getJSON(url, function (data) {
                    ...
                    arr.forEach((element) => {
                        ...
                        htmlElements +=
                            ...
                            "</path></svg><span>Mentor: " +
                            element.hostId +
                            '</span></li><li class="flex items-center space-x-2 text-lg font-medium text-gray-500">' +
                            '<svg class="w-6 h-6 text-green-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">' +
                            '<path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd">' +
                            "</path></svg><span>Platform: " +
...
=======
  ...
  <body>
    <section class="text-gray-600 body-font">
      ...
      <script>
        ...
        let i = 0;
        let urlAskPage =
          "http://localhost:8080/masa/member/meeting/ask_question.jsp";
        let userParam = "?user=";
        let meetingParam = "&meeting=";
        const urlThisPage =
          "http://localhost:8080/masa/member/meeting/index.jsp";
        const quotationMarks = '"';
        $.getJSON(url, function (data) {
          const arr = data["meetings"];
          const width = arr.length;
  ...
  <script
    ...
    crossorigin="anonymous"
  ></script>
>>>>>>> defaec5a22ca76684fa9f8c8a35038ad27e2d0f3
</html>
