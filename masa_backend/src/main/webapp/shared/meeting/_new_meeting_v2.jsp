                ...
                $.getJSON("/masa/api/meeting-management/new-meetings", function (data) {
                    ...
                    arr.forEach((element) => {
                        ...
                        htmlElements +=
                            ...
                            +'<h2 class="text-2xl text-indigo-600">with mentor <strong class="py-2 text-indigo-600">Tam Nhu</strong></h2>'
                            +'<p class="mt-4 text-gray-600">20:00 Oct 20th</p>'
                            +'<button'
                            +' type="button"'
                            +' data-toggle="modal"'
                ...
                $.getJSON("/masa/api/meeting-management/new-meetings", function (data) {
                    ...
                    arr.forEach((element) => {
                        ...
                        htmlDialogs +=
                            ...
                            +'<p class="mr-5 font-normal text-gray-500 ml-9">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Euismod ut sit lacus risus malesuada magna lectus. Aliquet viverra volutpat orci lacus aliquam, amet duis viverra. Auctor tortor facilisis magna praesent nunc, tristique felis amet, nibh. Lacinia mauris vulputate quis pretium sed. Arcu risus ac justo condimentum amet, mauris tempor. Posuere viverra pellentesque tempus euismod est aliquam sit enim massa. Potenti volutpat, sed turpis tempor arcu elementum.</p>'
                            +'</div>'
                            +'</div>'
