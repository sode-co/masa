            ...
            <div class="container px-5 py-24 mx-auto">
                ...
                <script>
                    ...
                    $.getJSON("http://localhost:8080/masa/api/meeting-management/meetings", function (data) {
                        ...
                        arr.forEach((element) => {
                            htmlElements += '<h1 id="meetingId" style="display: none">' + element.id + "</h1>";
                            ...
                            // '      <div class="block h-full py-4 bg-blue-600 rounded-lg shadow-inner lg:w-2/12">' +
                            ...
                            // '    <button type="button" class="px-4 mx-4 text-lg font-semibold leading-loose tracking-wider text-green-800 bg-blue-200 rounded" data-toggle="modal" data-target="#exampleModalCenter" style="background-color: #d1fae5; border: #d1fae5; color: black; font-weight: bold">' +
                            // "        See more" +
                            // "    </button>" +
                            // "       " +
                            // "      </div>" +
                            ...
                            '<div class="relative flex flex-col justify-between flex-1 max-w-md p-8 lg:p-6 xl:p-8 rounded-2xl mb-11">' +
                                ...
                                '<span class="absolute inset-0 w-full h-full transition-all duration-200 ease-out transform bg-blue-500 group-hover:translate-y-0 group-hover:translate-x-0 rounded-xl"></span>' +
