...
<div class="flex mb-7 w-full">
    <div class="ml-24 flex flex-col flex-1 float-left">
        <h1 class="mb-2 text-5xl font-medium text-gray-900 title-font" style="font-size: 20px">Followed Meetings</h1>
    ...
    <div class="container px-5 mx-auto" style="padding-left: 0px">
        ...
        <div  id="new_meeting_carousel_wrapper" class="mx-auto space-x-4 md:justify-center md:space-x-8 md:px-8" style="width: 940px;">
            <ul id="new_meeting_carousel_wrapper_list">
                <script>
                    let i=0;
                    const userIdSession = document.getElementById("currentSessionNewMeeting").innerText;
                    $.getJSON("${Masa.SERVER_HOST}/api/meeting-management/followed-meetings/"+userIdSession, function (data) {
                        console.log("${Masa.SERVER_HOST}/api/meeting-management/followed-meetings/"+userIdSession);
