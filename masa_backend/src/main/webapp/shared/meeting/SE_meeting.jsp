...
<html lang="en">
    ...
    <body>
        <div class="w-full mb-6 lg:mb-0 sm:ml-20">
            <h1 class="mb-2 text-3xl font-medium text-gray-900 sm:text-4xl title-font" style="font-size: 25px; font-weight: 300">
                Software Meetings
            </h1>
                ...
                <script>
                    ...
                    $.getJSON("/masa/api/meeting-management/topic/meetings/1", function (data) {
                        ...
                        arrNewMeeting.forEach((element) => {
                            ...
                            var startConvertNewMeetingTime = startConvertNewMeeting
                                .toString()
                            ...
                            var endConvertConvertNewMeetingTime = endConvertConvertNewMeeting
                                .toString()
                                .replace("GMT+0700 (Indochina Time)", "")
                                .replace("GMT+0800 (Indochina Time)", "");
                            i++;
                            htmlElements +=
                                ...
                                element.title +
                                "</h1>" +
                                '<h2 class="text-lg text-indigo-600">with mentor <strong class="text-indigo-600">' +
                                element.mentor.fullName +
                                "</strong></h2>" +
                                '<p class="mt-4 text-gray-600">' +
                                startConvertNewMeetingTime.slice(16, 21) +
                                " " +
                                startConvertNewMeetingTime.slice(4, 10) +
                                "</p>" +
                                "</div>" +
                                '<div class="card-footer">' +
                                "<button" +
                                ' type="button"' +
                                ' class="float-left px-3 py-2 mt-1 mb-4 mr-2 font-semibold tracking-widest text-white transition duration-200 bg-indigo-500 rounded-xl hover:bg-indigo-400"' +
                                " onclick=parent.calldialog(" +
                                element.id +
                                ")" +
                                ">" +
                                "See more" +
