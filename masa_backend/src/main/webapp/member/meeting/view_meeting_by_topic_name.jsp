    ...
    <body>
        ...
        <div class="container flex items-center mx-auto bg-green-100 rounded-md h-96">
            <div class="text-center sm:ml-20 text-gray-50 sm:text-left">
                <h1 class="mb-4 text-5xl font-bold text-green-800">Hi ${sessionScope.CURRENT_USER.fullName}! <br /></h1>
                <c:if test="${sessionScope.CURRENT_USER.getRole() == 'UserRole{type=MEMBER}'}">
                    <a
                ...
                <p class="inline-block text-3xl text-gray-600 sm:block">Many interesting meetings are coming up....</p>
            </div>
        </div>
        ...
        <br />
        <div><%@ include file="../../shared/meeting/_meeting_by_topic_name.jsp"%></div>
        <div></div>
        <!-- Footer -->
