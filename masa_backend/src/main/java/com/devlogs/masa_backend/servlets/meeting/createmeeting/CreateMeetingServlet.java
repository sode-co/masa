...
public class CreateMeetingServlet extends BaseHttpServlet {
    ...
    private void createMeeting(CreateMeetingReq reqBody, HttpServletResponse resp) throws IOException {
        ...
        CreateMeetingUseCase.Result result = createMeetingUseCase.executes(reqBody.getTitle(), new MeetingPlatform(meetingPlatform, reqBody.getPlatformUrl()), reqBody.getHost(), reqBody.getStartTime(), reqBody.getEndTime(), reqBody.getDescription());
