...
public class GetAllUserFollowedMeetingUseCase {
    ...
    @Inject
    public GetAllUserFollowedMeetingUseCase(MeetingRepository meetingRepository, UserRepository userRepository) {
    ...
    public Result executes (String userId) {
        try {
            ...
            List<MeetingEntity> meetings = meetingRepository.getFollowedMeetings(userId);
