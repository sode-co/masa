...
public class GetOnGoingMeetingUseCase {
    ...
    @Inject
    public GetOnGoingMeetingUseCase(MeetingRepository meetingRepository) {
        this.meetingRepository = meetingRepository;
    }

    public Result executes () {
        try {
            List<MeetingEntity> meetings = meetingRepository.getOnGoingMeetings();
