...
public class GetNumOfActiveMeetingsUseCase {
    ...
    @Inject
    public GetNumOfActiveMeetingsUseCase(MeetingRepository meetingRepository) {
        this.meetingRepository = meetingRepository;
    }

    public Result executes () {
        try {
            int numOfMeetings = meetingRepository.countAllActiveMeetings();
